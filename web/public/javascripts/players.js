$(document).ready(function() {
	...
	entry.find('.f_kills').html(
	    Common.bar(player.total_kills,
		       Common.sum([player.total_kills,player.total_deaths,player.total_bdeaths]),null));
	...
	entry.find('.f_buildings').html(Common.bar(player.total_built,Common.sum([player.total_built,player.total_bkills]),null));
